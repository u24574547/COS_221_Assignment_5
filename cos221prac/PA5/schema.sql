...
CREATE TABLE `products` (
  ...
  `images` varchar(255) NOT NULL DEFAULT '[]' COMMENT 'array of images potentially maybe?',
...
CREATE TABLE `user` (
  ...
  `password` varchar(45) NOT NULL COMMENT 'store hashed passwords for safety',
...
-- Dump completed on 2025-05-13 16:50:20
